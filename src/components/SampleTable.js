    ...
    let childBody = data.map(result => {
      return (
        <TableRows key={result.id}>
          ...
          <TableRow>
            <Moment format="DD-MM-YYYY hh:mm a">{result.DOB}</Moment>
          </TableRow>
        </TableRows>
      );
    });
  ...
  function renderTableHeader(props) {
    return (
      <TableColumns {...props}>
        ...
        <TableColumn id="first_name" sortable={true}>
          First Name
        </TableColumn>
        <TableColumn id="last_name" sortable={true}>
          Last Name
        </TableColumn>
        <TableColumn id="email" sortable={true}>
          Email
        </TableColumn>
        <TableColumn id="gender">Gender</TableColumn>
        <TableColumn id="DOB" sortable={true}>
          Date of Birth
        </TableColumn>
      </TableColumns>
    );
